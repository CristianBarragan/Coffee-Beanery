...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<Contract, DataEntity.Contract>()
            ...
            .ForMember(dest => dest.ContractKey, 
                opt => opt.MapFrom(ps => ps.ContractKey))
            ...
            .ForMember(dest => dest.CustomerBankingRelationshipId, opt => opt.Ignore())
            .ForMember(dest => dest.Id, opt => opt.Ignore())
            .ForMember(dest => dest.Schema, opt => 
                opt.Ignore())
            .ForMember(dest => dest.ProcessedDateTime, opt => opt.Ignore())
        ...
        CreateMap<CustomerBankingRelationship, DataEntity.CustomerBankingRelationship>()
            ...
            .ForMember(dest => dest.CustomerBankingRelationshipKey, 
                opt => opt.MapFrom(ps => ps.CustomerBankingRelationshipKey))
